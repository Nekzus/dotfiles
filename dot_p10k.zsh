# Generated by Powerlevel10k configuration wizard on 2022-10-22 at 18:47 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # nodeenv    
    # node.js environment (https://github.com/ekalinin/nodeenv)
    ...
    # terraform 
    # terraform workspace (https://www.terraform.io)
    ...
    # google_app_cred 
    # google application credentials (https://cloud.google.com/docs/authentication/production)
